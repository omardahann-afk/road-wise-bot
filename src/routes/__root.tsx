...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AI-powered diagnostics, repairs, and used-car inspection — in your pocket." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "AutoSage AI — Your AI Mechanic" },
      { name: "twitter:description", content: "AI-powered diagnostics, repairs, and used-car inspection — in your pocket." },
